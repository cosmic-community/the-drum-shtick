...
export const metadata: Metadata = {
  title: 'About Us | The Drum Shtick',
  description:
    'Learn about The Drum Shtick — your one-stop shop for quality drums, drum sets, sticks, and accessories.',
};
...
export default async function AboutPage() {
    ...
    return (
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        ...
        <p className="text-charcoal-500">
          About page content is not available at this time. Please check back
          later.
        </p>
        <Link
          href="/"
  ...
  const heading = page.metadata?.heading ?? 'About Us';
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
      ...
      <nav className="flex items-center gap-2 text-sm text-charcoal-400 mb-8">
        ...
        <span>/</span>
        <span className="text-charcoal-700">About</span>
      </nav>
